  ...
  Widget build(BuildContext context) {
    return Opacity(
      ...
      child: CachedNetworkImage(
        ...
        placeholder: (context, url) => Icon(Icons.downloading_outlined, size: height, color: WrestlingColors.color_red),
        errorWidget: (context, url, error) => Icon(Icons.error, size: height, color: WrestlingColors.color_red),
      ),
    );
  }
...
//         borderRadius: BorderRadius.circular(circular),
//         image: const DecorationImage(
//             image: AssetImage('assets/images/icon_inreservy.jpg'),
//             fit: BoxFit.cover
//         )
//     ),
//   );
