...
class GetCommentsNewsUseCase implements UseCase<DataState<List<Comment>>, String> {
  GetCommentsNewsUseCase(this._mainRepository);

  final MainRepository _mainRepository;

  @override
  Future<DataState<List<Comment>>> call({void params}) async {
    return _mainRepository.getCommentsNews(params as String);
  }
}